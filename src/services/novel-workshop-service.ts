...
- 对重要人物拆成多条世界书：核心设定、外貌、行为逻辑、三面性（日常面/压力面/隐藏面）、关键关系等。
...
- 人物条目尽量覆盖：核心身份与动机、心理动态（用具体念头/身体感受，不写结论句）、行为模式 3-5 条、对话风格（整体语气 + 3-5 句典型台词）、对他人态度、触发/消退条件、身体/环境细节、记忆/闪回、三面性（日常面/压力面/隐藏面，用具体行为描写）。
