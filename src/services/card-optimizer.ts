...
6. 角色描述或条目内容中的以下结构必须完整保留，严禁简化或删除：
   a) 性格调色盘（底色/主色调/点缀/衍生）：保留每层特质的衍生行为细节
   b) 二次解释（"不是...而是..."、"看似...实则..."等）：保留防刻板印象的澄清
   c) 三面性章节（## 三面性 及其下的日常面/压力面/隐藏面）：这是角色在不同压力下的行为分层，必须原样保留章节标题和三个面的内容，不得合并或删减
